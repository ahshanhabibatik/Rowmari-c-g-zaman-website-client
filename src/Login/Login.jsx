        ...
        <div>
            ...
            <div data-aos="fade-up" className="grid mt-6 border-2 w-[600px] mx-auto bg-slate-300 py-11">
                ...
                <div className=" ">
                    ...
                    <div>
                        <p className="text-center text-gray-600 font-bold mt-5">New to Rcgzhs. Please<Link className="text-blue-600 underline font-bold" to={'/register'}> Register</Link></p>
                    </div>
                </div>
