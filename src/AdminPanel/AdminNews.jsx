            ...
            <div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="form-control">
                        ...
                        <input type="text"  {...register("head", { required: true })} name="head" placeholder="Write your news Heading" className="input input-bordered border-lime-400" />
                    ...
                    <input
                        type="submit"
                        className="border-2 hover:bg-green-400 px-10 uppercase rounded-xl cursor-pointer border-orange-400 py-4 mx-auto flex mt-4"
                        value="Submit News"
                    />
                </form>
            </div>
